...
class TestStudentController(BaseTest):
    ...
    def test_get_all_students(self, email: str, password: str, expected_status_code: str, expected_body: str):
    ...
    def test_create_student(self, email, password, expected_status_code):
        credentials = {"email": email, "password": password}
    ...
    def test_get_student_by_id(self, email, password, expected_status_code):
        credentials = {"email": email, "password": password}
    ...
    def test_update_student(self, email, password, expected_status_code):
        credentials = {"email": email, "password": password}
    ...
    def test_delete_student(self, email, password, expected_status_code):
        credentials = {"email": email, "password": password}
